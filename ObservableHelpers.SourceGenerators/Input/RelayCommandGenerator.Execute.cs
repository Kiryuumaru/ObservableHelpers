    ...
    internal static class Execute
    {
        ...
        public static ImmutableArray<MemberDeclarationSyntax> GetSyntax(CommandInfo commandInfo)
        {
            ...
            if (commandInfo.AllowConcurrentExecutions && !commandInfo.FlowExceptionsToTaskScheduler)
            {
                commandCreationArguments.Add(
                    Argument(MemberAccessExpression(
                        ...
                        IdentifierName("global::ObservableHelpers.Input.AsyncRelayCommandOptions"),
            ...
            if (commandInfo.IncludeCancelCommand)
            {
                ...
                // [global::System.CodeDom.Compiler.GeneratedCode("...", "...")]
                // [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                // public global::System.Windows.Input.ICommand <CANCEL_COMMAND_PROPERTY_NAME> => <CANCEL_COMMAND_FIELD_NAME> ??= global::ObservableHelpers.Input.IAsyncRelayCommandExtensions.CreateCancelCommand(<COMMAND_PROPERTY_NAME>);
                        ...
                        ArrowExpressionClause(
                            AssignmentExpression(
                                ...
                                InvocationExpression(
                                    MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression,
                                        IdentifierName("global::ObservableHelpers.Input.IAsyncRelayCommandExtensions"),
        ...
        private static bool IsCommandDefinitionUnique(IMethodSymbol methodSymbol, ImmutableArray<Diagnostic>.Builder diagnostics)
        {
            ...
            foreach (ISymbol symbol in methodSymbol.ContainingType.BaseType?.GetAllMembers(methodSymbol.Name) ?? Enumerable.Empty<ISymbol>())
            {
                if (symbol is IMethodSymbol otherSymbol &&
                    otherSymbol.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.Input.RelayCommandAttribute"))
                {
                    diagnostics.Add(
            ...
            out ImmutableArray<string> delegateTypeArgumentsWithNullabilityAnnotations)
        {
            ...
            {
                commandInterfaceType = "global::ObservableHelpers.Input.IRelayCommand";
                commandClassType = "global::ObservableHelpers.Input.RelayCommand";
                ...
                methodSymbol.ReturnType.InheritsFromFullyQualifiedName("global::System.Threading.Tasks.Task"))
            {
                ...
                {
                    commandInterfaceType = "global::ObservableHelpers.Input.IAsyncRelayCommand";
                    commandClassType = "global::ObservableHelpers.Input.AsyncRelayCommand";
            ...
            out bool allowConcurrentExecutions)
        {
            ...
            if (commandClassType is "global::ObservableHelpers.Input.AsyncRelayCommand")
            {
                return true;
            }
            else
            ...
            foreach (ISymbol memberSymbol in containingType.GetAllMembers())
            {
                ...
                if (memberSymbol is IFieldSymbol &&
                    !attributes.Any(static a => a.AttributeClass?.HasFullyQualifiedName(
                        "global::ObservableHelpers.ComponentModel.ObservablePropertyAttribute") == true))
                {
                    continue;
                }
