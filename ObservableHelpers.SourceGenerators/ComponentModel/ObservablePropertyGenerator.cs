...
using ObservableHelpers.SourceGenerators.Models;
...
public sealed partial class ObservablePropertyGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValuesProvider<IFieldSymbol> fieldSymbolsWithAttribute =
            fieldSymbols
            .Where(static item => item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservablePropertyAttribute"));
        ...
        IncrementalValuesProvider<Diagnostic> fieldSymbolsWithOrphanedDependentAttributeWithErrors =
            fieldSymbols
            .Where(static item =>
                (item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedForAttribute") ||
                 item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyCanExecuteChangedForAttribute") ||
                 item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedRecipientsAttribute") ||
                 item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyDataErrorInfoAttribute")) &&
                 !item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservablePropertyAttribute"))
        ...
        IncrementalValuesProvider<Diagnostic> notifyRecipientsErrors =
            classSymbols
            .Where(static item => item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedRecipientsAttribute"))
        ...
        IncrementalValuesProvider<Diagnostic> notifyDataErrorInfoErrors =
            classSymbols
            .Where(static item => item.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyDataErrorInfoAttribute"))
