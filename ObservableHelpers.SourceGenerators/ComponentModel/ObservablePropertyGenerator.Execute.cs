    ...
    internal static class Execute
    {
        ...
        public static PropertyInfo? TryGetInfo(IFieldSymbol fieldSymbol, out ImmutableArray<Diagnostic> diagnostics)
        {
            ...
            foreach (AttributeData attributeData in fieldSymbol.GetAttributes())
            {
                ...
                // Gather property access modifiers
                if (TryGatherPropertyAccessModifiers(attributeData, out accessModifier))
                {
                    continue;
                }
            ...
            if (hasAnyValidationAttributes &&
                !fieldSymbol.ContainingType.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableValidator"))
            {
                builder.Add(
            ...
            out bool shouldInvokeOnPropertyChanging)
        {
            ...
            bool isObservableObject = fieldSymbol.ContainingType.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableObject");
            bool hasObservableObjectAttribute = fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableObjectAttribute");
            bool hasINotifyPropertyChangedAttribute = fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.INotifyPropertyChangedAttribute");
            ...
            ImmutableArray<Diagnostic>.Builder diagnostics)
        {
            ...
            bool IsPropertyNameValidWithGeneratedMembers(string propertyName)
            {
                foreach (ISymbol member in fieldSymbol.ContainingType.GetAllMembers())
                {
                    if (member is IFieldSymbol otherFieldSymbol &&
                        ...
                        otherFieldSymbol.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservablePropertyAttribute") &&
            ...
            if (attributeData.AttributeClass?.HasFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedForAttribute") == true)
            {
            ...
            ImmutableArray<Diagnostic>.Builder diagnostics)
        {
            ...
            bool IsCommandNameValid(string commandName, out bool shouldLookForGeneratedMembersToo)
            {
                ...
                if (fieldSymbol.ContainingType.GetAllMembers(commandName).OfType<IPropertySymbol>().FirstOrDefault() is IPropertySymbol propertySymbol)
                {
                    ...
                    if (propertySymbol.Type is INamedTypeSymbol typeSymbol &&
                        (typeSymbol.HasFullyQualifiedName("global::ObservableHelpers.Input.IRelayCommand") ||
                         typeSymbol.HasInterfaceWithFullyQualifiedName("global::ObservableHelpers.Input.IRelayCommand")))
                    {
            ...
            bool IsCommandNameValidWithGeneratedMembers(string commandName)
            {
                foreach (ISymbol member in fieldSymbol.ContainingType.GetAllMembers())
                {
                    if (member is IMethodSymbol methodSymbol &&
                        methodSymbol.HasAttributeWithFullyQualifiedName("global::ObservableHelpers.Input.RelayCommandAttribute") &&
            ...
            if (attributeData.AttributeClass?.HasFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyCanExecuteChangedForAttribute") == true)
            {
        ...
        /// <summary>
        /// Tries to gather properties access modifier from the given attribute.
        /// </summary>
        /// <param name="attributeData">The <see cref="AttributeData"/> instance to gather.</param>
        /// <param name="accessModifier">The integer identifier for the access modifier.</param>
        /// <returns>Whether or not <paramref name="attributeData"/> was an attribute containing properties access modifier.</returns>
        private static bool TryGatherPropertyAccessModifiers(AttributeData attributeData, out int accessModifier)
        {
            accessModifier = 0;

            if (attributeData.AttributeClass?.HasFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservablePropertyAttribute") == true)
            {
                KeyValuePair<string, TypedConstant> accessArgs = attributeData.NamedArguments.FirstOrDefault(i => i.Key == "Access");

                if (int.TryParse(accessArgs.Value.Value?.ToString(), out accessModifier))
                {
                    return true;
                }
        ...
        {
            if (fieldSymbol.ContainingType?.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedRecipientsAttribute") == true)
            {
                // If the containing type is valid, track it
                if (fieldSymbol.ContainingType.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableRecipient") ||
                    fieldSymbol.ContainingType.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableRecipientAttribute"))
                {
        ...
        {
            if (attributeData.AttributeClass?.HasFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyPropertyChangedRecipientsAttribute") == true)
            {
        ...
        public static Diagnostic? GetIsNotifyingRecipientsDiagnosticForType(INamedTypeSymbol typeSymbol)
        {
            ...
            if (!typeSymbol.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableRecipient") &&
                !typeSymbol.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableRecipientAttribute"))
            {
        ...
        {
            if (fieldSymbol.ContainingType?.HasOrInheritsAttributeWithFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyDataErrorInfoAttribute") == true)
            {
                // If the containing type is valid, track it
                if (fieldSymbol.ContainingType.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableValidator"))
                {
        ...
        {
            if (attributeData.AttributeClass?.HasFullyQualifiedName("global::ObservableHelpers.ComponentModel.NotifyDataErrorInfoAttribute") == true)
            {
                // Emit a diagnostic if the attribute is unnecessary
        ...
        {
            // If the containing type is valid, track it
            if (!typeSymbol.InheritsFromFullyQualifiedName("global::ObservableHelpers.ComponentModel.ObservableValidator"))
            {
                return Diagnostic.Create(
        ...
        public static MemberDeclarationSyntax GetPropertySyntax(PropertyInfo propertyInfo)
        {
            ...
            // Get the property access modifiers
            SyntaxKind[] propertyAccessModifier = propertyInfo.AccessModifier switch
            {
                1 => new[] { SyntaxKind.PublicKeyword },
                2 => new[] { SyntaxKind.ProtectedKeyword },
                3 => new[] { SyntaxKind.InternalKeyword },
                4 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                5 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                6 => new[] { SyntaxKind.PrivateKeyword },

                //Getter

                7 => new[] { SyntaxKind.PublicKeyword },
                8 => new[] { SyntaxKind.PublicKeyword },
                9 => new[] { SyntaxKind.PublicKeyword },
                10 => new[] { SyntaxKind.PublicKeyword },
                11 => new[] { SyntaxKind.PublicKeyword },

                12 => new[] { SyntaxKind.ProtectedKeyword },
                13 => new[] { SyntaxKind.ProtectedKeyword },
                14 => new[] { SyntaxKind.ProtectedKeyword },
                15 => new[] { SyntaxKind.ProtectedKeyword },

                16 => new[] { SyntaxKind.InternalKeyword },
                17 => new[] { SyntaxKind.InternalKeyword },
                18 => new[] { SyntaxKind.InternalKeyword },

                19 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                20 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },

                21 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },

                //Setter

                22 => new[] { SyntaxKind.PublicKeyword },
                23 => new[] { SyntaxKind.PublicKeyword },
                24 => new[] { SyntaxKind.PublicKeyword },
                25 => new[] { SyntaxKind.PublicKeyword },
                26 => new[] { SyntaxKind.PublicKeyword },

                27 => new[] { SyntaxKind.ProtectedKeyword },
                28 => new[] { SyntaxKind.ProtectedKeyword },
                29 => new[] { SyntaxKind.ProtectedKeyword },
                30 => new[] { SyntaxKind.ProtectedKeyword },

                31 => new[] { SyntaxKind.InternalKeyword },
                32 => new[] { SyntaxKind.InternalKeyword },
                33 => new[] { SyntaxKind.InternalKeyword },

                34 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                35 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },

                36 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },

                _ => new[] { SyntaxKind.PublicKeyword }
            };
            SyntaxKind[] getterAccessModifier = propertyInfo.AccessModifier switch
            {
                7 => new[] { SyntaxKind.ProtectedKeyword },
                8 => new[] { SyntaxKind.InternalKeyword },
                9 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                10 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                11 => new[] { SyntaxKind.PrivateKeyword },

                12 => new[] { SyntaxKind.InternalKeyword },
                13 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                14 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                15 => new[] { SyntaxKind.PrivateKeyword },

                16 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                17 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                18 => new[] { SyntaxKind.PrivateKeyword },

                19 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                20 => new[] { SyntaxKind.PrivateKeyword },

                21 => new[] { SyntaxKind.PrivateKeyword },

                _ => Array.Empty<SyntaxKind>()
            };
            SyntaxKind[] setterAccessModifier = propertyInfo.AccessModifier switch
            {
                22 => new[] { SyntaxKind.ProtectedKeyword },
                23 => new[] { SyntaxKind.InternalKeyword },
                24 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                25 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                26 => new[] { SyntaxKind.PrivateKeyword },

                27 => new[] { SyntaxKind.InternalKeyword },
                28 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                29 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                30 => new[] { SyntaxKind.PrivateKeyword },

                31 => new[] { SyntaxKind.ProtectedKeyword, SyntaxKind.InternalKeyword },
                32 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                33 => new[] { SyntaxKind.PrivateKeyword },

                34 => new[] { SyntaxKind.PrivateKeyword, SyntaxKind.ProtectedKeyword },
                35 => new[] { SyntaxKind.PrivateKeyword },

                36 => new[] { SyntaxKind.PrivateKeyword },
            ...
            foreach (string propertyName in propertyInfo.PropertyChangingNames)
            {
                // This code generates a statement as follows:
                //
                // OnPropertyChanging(global::ObservableHelpers.ComponentModel.__Internals.__KnownINotifyPropertyChangingArgs.<PROPERTY_NAME>);
                setterStatements.Add(
                    ExpressionStatement(
                        InvocationExpression(IdentifierName("OnPropertyChanging"))
                        .AddArgumentListArguments(Argument(MemberAccessExpression(
                            SyntaxKind.SimpleMemberAccessExpression,
                            IdentifierName("global::ObservableHelpers.ComponentModel.__Internals.__KnownINotifyPropertyChangingArgs"),
            ...
            foreach (string propertyName in propertyInfo.PropertyChangedNames)
            {
                // This code generates a statement as follows:
                //
                // OnPropertyChanging(global::ObservableHelpers.ComponentModel.__Internals.__KnownINotifyPropertyChangedArgs.<PROPERTY_NAME>);
                setterStatements.Add(
                    ExpressionStatement(
                        InvocationExpression(IdentifierName("OnPropertyChanged"))
                        .AddArgumentListArguments(Argument(MemberAccessExpression(
                            SyntaxKind.SimpleMemberAccessExpression,
                            IdentifierName("global::ObservableHelpers.ComponentModel.__Internals.__KnownINotifyPropertyChangedArgs"),
                            IdentifierName(propertyName))))));
            }
            ...
            // <ACCESS_MODIFIER> <FIELD_TYPE><NULLABLE_ANNOTATION?> <PROPERTY_NAME>
            // {
            //     <ACCESS_MODIFIER> get => <FIELD_NAME>;
            //     <ACCESS_MODIFIER> set
            //     {
            //         <BODY>
            //     }
            ...
            return
                ...
                .AddModifiers(propertyAccessModifier.Select(modifier => Token(modifier)).ToArray())
                .AddAccessorListAccessors(
                    AccessorDeclaration(SyntaxKind.GetAccessorDeclaration)
                    .AddModifiers(getterAccessModifier.Select(modifier => Token(modifier)).ToArray())
                    .WithExpressionBody(ArrowExpressionClause(IdentifierName(propertyInfo.FieldName)))
                    .WithSemicolonToken(Token(SyntaxKind.SemicolonToken)),
                    AccessorDeclaration(SyntaxKind.SetAccessorDeclaration)
                    .AddModifiers(setterAccessModifier.Select(modifier => Token(modifier)).ToArray())
            ...
            ImmutableArray<string> names)
        {
            ...
            // #nullable enable
            // namespace ObservableHelpers.ComponentModel.__Internals
            // {
            //     [global::System.CodeDom.Compiler.GeneratedCode("...", "...")]
            ...
            return
                ...
                NamespaceDeclaration(IdentifierName("ObservableHelpers.ComponentModel.__Internals")).WithLeadingTrivia(TriviaList(
