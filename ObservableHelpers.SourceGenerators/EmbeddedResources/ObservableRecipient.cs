...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="global::ObservableHelpers.ComponentModel.ObservableRecipient"/> class.
    /// </summary>
    /// <remarks>
    /// This constructor will produce an instance that will use the <see cref="global::ObservableHelpers.Messaging.WeakReferenceMessenger.Default"/> instance
    ...
    protected ObservableRecipient()
        : this(global::ObservableHelpers.Messaging.WeakReferenceMessenger.Default)
    {
    }
    ...
    /// Initializes a new instance of the <see cref="global::ObservableHelpers.ComponentModel.ObservableRecipient"/> class.
    /// </summary>
    /// <param name="messenger">The <see cref="global::ObservableHelpers.Messaging.IMessenger"/> instance to use to send messages.</param>
    protected ObservableRecipient(global::ObservableHelpers.Messaging.IMessenger messenger)
    {
        Messenger = messenger;
    }

    /// <summary>
    /// Gets the <see cref="global::ObservableHelpers.Messaging.IMessenger"/> instance in use.
    /// </summary>
    protected global::ObservableHelpers.Messaging.IMessenger Messenger { get; }
    ...
    public bool IsActive
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresUnreferencedCode(
            ...
            "This method requires the generated ObservableHelpers.Messaging.__Internals.__IMessengerExtensions type not to be removed to use the fast path. " +
    ...
    {
        global::ObservableHelpers.Messaging.IMessengerExtensions.RegisterAll(Messenger, this);
    }
    ...
    /// <summary>
    /// Broadcasts a <see cref="global::ObservableHelpers.Messaging.Messages.PropertyChangedMessage{T}"/> with the specified
    ...
    {
        var message = new global::ObservableHelpers.Messaging.Messages.PropertyChangedMessage<T>(this, propertyName, oldValue, newValue);

        _ = global::ObservableHelpers.Messaging.IMessengerExtensions.Send(Messenger, message);
    }

    /// <summary>
    /// Compares the current and new values for a given property. If the value has changed,
    /// raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> event, updates the property with
    /// the new value, then raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> event.
    /// </summary>
    /// <typeparam name="T">The type of the property that changed.</typeparam>
    ...
    /// <remarks>
    /// This method is just like <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{T}(ref T,T,string)"/>, just with the addition
    /// of the <paramref name="broadcast"/> parameter. As such, following the behavior of the base method,
    /// the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> and <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> events
    ...
    /// Compares the current and new values for a given property. If the value has changed,
    /// raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> event, updates the property with
    /// the new value, then raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> event. Similarly to
    /// the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{T}(T,T,global::System.Action{T},string)"/> method, this overload should only be
    /// used when <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{T}(ref T,T,string)"/> can't be used directly.
    /// </summary>
    /// <typeparam name="T">The type of the property that changed.</typeparam>
    ...
    /// <returns><see langword="true"/> if the property was changed, <see langword="false"/> otherwise.</returns>
    /// <remarks>
    /// This method is just like <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{T}(T,T,global::System.Action{T},string)"/>, just with the addition
    /// of the <paramref name="broadcast"/> parameter. As such, following the behavior of the base method,
    /// the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> and <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> events
    /// are not raised if the current and new value for the target property are the same.
    /// </remarks>
    ...
    /// raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> event, updates the property and then raises the
    /// <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> event. The behavior mirrors that of
    /// <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{TModel,T}(T,T,TModel,global::System.Action{TModel,T},string)"/>, with the difference being that this
    /// method is used to relay properties from a wrapped model in the current instance. For more info, see the docs for
    /// <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{TModel,T}(T,T,TModel,global::System.Action{TModel,T},string)"/>.
    /// </summary>
    ...
    /// raises the <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanging"/> event, updates the property and then raises the
    /// <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.PropertyChanged"/> event. The behavior mirrors that of
    /// <see cref="global::ObservableHelpers.ComponentModel.ObservableObject.SetProperty{TModel,T}(T,T,global::System.Collections.Generic.IEqualityComparer{T},TModel,global::System.Action{TModel,T},string)"/>,
