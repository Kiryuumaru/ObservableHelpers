...
public abstract class ObservableObject : global::System.ComponentModel.INotifyPropertyChanged, global::System.ComponentModel.INotifyPropertyChanging
{
    ...
    /// </summary>
    public event global::System.ComponentModel.PropertyChangedEventHandler? SynchronizedPropertyChanged;

    /// <summary>
    /// Event raised when a property is changed directly on the executing thread.
    /// </summary>
    public event global::System.ComponentModel.PropertyChangedEventHandler? UnsynchronizedPropertyChanged;

    /// <inheritdoc cref="global::System.ComponentModel.INotifyPropertyChanging.PropertyChanging"/>
    public event global::System.ComponentModel.PropertyChangingEventHandler? PropertyChanging;

    /// <summary>
    /// Event raised on the current synchronization context when a property is changing.
    /// </summary>
    public event global::System.ComponentModel.PropertyChangingEventHandler? SynchronizedPropertyChanging;

    /// <summary>
    /// Event raised when a property is changing directly on the executing thread.
    /// </summary>
    public event global::System.ComponentModel.PropertyChangingEventHandler? UnsynchronizedPropertyChanging;

    /// <summary>
    /// Gets the <see cref="SynchronizationContextHelpers.SyncOperation"/> of the object.
    /// </summary>
    public SynchronizationContextHelpers.SyncOperation SyncOperation { get; } = new SynchronizationContextHelpers.SyncOperation();
    ...
    /// <summary>
    /// Gets or sets <c>true</c> if the <see cref="PropertyChanging"/> event will invoke on the synchronized context.
    /// </summary>
    public bool SynchronizePropertyChangingEvent { get; set; }

    /// <summary>
    /// Raises <see cref="PropertyChanged"/>, <see cref="SynchronizedPropertyChanged"/> and <see cref="UnsynchronizedPropertyChanged"/>.
    /// </summary>
    ...
    {
        UnsynchronizedPropertyChanged?.Invoke(this, e);
        SyncOperation.ContextPost(delegate
        {
            SynchronizedPropertyChanged?.Invoke(this, e);
        });
    ...
    /// <summary>
    /// Raises <see cref="PropertyChanging"/>, <see cref="SynchronizedPropertyChanging"/> and <see cref="UnsynchronizedPropertyChanging"/>.
    /// </summary>
    ...
    {
        UnsynchronizedPropertyChanging?.Invoke(this, e);
        SyncOperation.ContextPost(delegate
        {
            SynchronizedPropertyChanging?.Invoke(this, e);
        });

        if (SynchronizePropertyChangingEvent)
        {
            SyncOperation.ContextPost(delegate
            {
        ...
        where TTask : global::System.Threading.Tasks.Task
    {
        ...
        {
            await global::ObservableHelpers.ComponentModel.__Internals.__TaskExtensions.GetAwaitableWithoutEndValidation(newValue!);
