...
using ObservableHelpers.Messaging.Internals;

namespace ObservableHelpers.Messaging;
...
public static class IMessengerExtensions
{
    ...
    public static void RegisterAll(this IMessenger messenger, object recipient)
    {
        ...
        {
            if (recipientType.Assembly.GetType("ObservableHelpers.Messaging.__Internals.__IMessengerExtensions") is Type extensionsType &&
