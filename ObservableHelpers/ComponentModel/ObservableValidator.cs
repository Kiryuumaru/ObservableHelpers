...
public abstract class ObservableValidator : ObservableObject, INotifyDataErrorInfo
{
    ...
    [RequiresUnreferencedCode(
        "This method requires the generated ObservableHelpers.ComponentModel.__Internals.__ObservableValidatorExtensions type not to be removed to use the fast path. " +
    ...
    protected void ValidateAllProperties()
    {
        ...
        {
            if (type.Assembly.GetType("ObservableHelpers.ComponentModel.__Internals.__ObservableValidatorExtensions") is Type extensionsType &&
