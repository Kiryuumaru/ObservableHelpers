...
public class ReadOnlyQueue : ObservableQueue<int>
{
...
public class IsEmptyTest
{
    ...
    public void Normal()
    {
        var col1 = new ObservableQueue<int>();
        var col2 = new ObservableQueue<int>(new int[] { 1, 2, 3, 4 });
...
public class ConstructorTest
{
    ...
    {
        var col = new ObservableQueue<int>(new int[] { 1, 2, 3, 4 });
...
public class EnqueueRangeTest
{
    ...
    public void Normal()
    {
        ...
        var col1 = new ObservableQueue<int>();
        var col2 = new ObservableQueue<int>();
        var col3 = new ObservableQueue<int>();
        var col4 = new ObservableQueue<int>();
...
public class PeekTest
{
    ...
    public void Normal()
    {
        var col1 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
        var col2 = new ObservableQueue<int>(new int[] { 3, 2, 1 });
...
public class TryDequeueRangeTest
{
    ...
    public void Normal()
    {
        ...
        var col1 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
        var col2 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
        var col3 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
        var col4 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
        var col5 = new ObservableQueue<int>(new int[] { 1, 2, 3 });
